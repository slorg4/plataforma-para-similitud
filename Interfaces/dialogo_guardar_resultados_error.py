...
class Ui_DialogGuardarResultadosError(object):
    def setupUi(self, DialogGuardarResultadosError):
        DialogGuardarResultadosError.setObjectName("DialogGuardarResultadosError")
        DialogGuardarResultadosError.resize(265, 100)
        DialogGuardarResultadosError.setMinimumSize(QtCore.QSize(265, 100))
        DialogGuardarResultadosError.setMaximumSize(QtCore.QSize(265, 100))
...
"background-color: rgb(110, 110, 110);")
    ...
    def retranslateUi(self, DialogGuardarResultadosError):
        ...
        self.label.setText(_translate("DialogGuardarResultadosError", "<html><head/><body><p>ERROR:</p><p>El nombre de archivo ya existe o no está disponible</p></body></html>"))
